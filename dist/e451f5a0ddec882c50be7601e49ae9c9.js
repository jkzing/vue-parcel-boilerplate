...
if (module.hot) {
  (function () {
    ...
    module.hot.accept();
    if (!module.hot.data) {
      hotAPI.createRecord("data-v-3b940ca0", __vue__options__);
    } else {
      hotAPI.reload("data-v-3b940ca0", __vue__options__);
    }
  })();
}
},{"vue-hot-reload-api":7,"vue":6}],4:[function(require,module,exports) {
"use strict";
...
},{"vue":6,"./App":5}],0:[function(require,module,exports) {
var global = (1, eval)('this');
...
if (!module.bundle.parent) {
    var ws = new WebSocket('ws://localhost:62992/');
    ws.onmessage = (e) => {
